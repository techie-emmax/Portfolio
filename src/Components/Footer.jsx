    ...
    <div className="w-full">
      <div className="flex flex-col md:flex-row items-top gap-4 md:gap-44 bg-[#116986ff] mt-15">
        ...
        <div className="flex flex-col items-center gap-3">
          <h3 className="font-Space-grotesk text-[24px] font-bold text-cyan-200">
            Connect
          </h3>
          <NavLink
            className="text-white md:hover:scale-110 font-Space-grotesk text-[18px]"
            to="/"
          >
            Home
          </NavLink>
        ...
        <div className="flex flex-col gap-3 items-center">
          ...
          <NavLink
            className="text-white font-Space-grotesk text-[18px]"
      ...
      <p className="text-center mt-1 pt-3 pb-3 font-regular font-Space-grotesk text-sm bg-[#116986ff] md:text-[18px] text-[#d5d8e2]">
        Copyright © {new Date().getFullYear()} Techie-Emmax. All Rights Reserved
      </p>
    </div>
  );
};
